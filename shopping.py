...
while True:
    try:
        checkout = input("Enter Product ID or 'DONE': ")
        if int(checkout) in range(0,len(products) + 1):
            shop_list.append(int(checkout))
        else:
...
print("-------------------------------------------")
print("ANDREW'S PLACE")
print("-------------------------------------------")
print("Web: www.andrewsplacenyc.com")
print("Phone: 1.212.555.0515")
...
print("NYC Sales Tax (8.875%): " + '${0:.2f}'.format(total*.08875))
